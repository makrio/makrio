if RUBY_PLATFORM.downcase.match(/darwin/)
  ...
  `[ -f #{Rails.root}/vendor/phantomjs/ChangeLog ] &&  echo "Phantom is Loaded" || (cd #{Rails.root}/vendor && curl #{phantom16} | tar xj)`
  PHANTOM_PATH = '/app/vendor/phantomjs-1.6.0-linux-x86_64-dynamic/bin/phantomjs'
end